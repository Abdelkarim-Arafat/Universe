...
public static class DefaultUsers
{
    ...
    // AcadimicAdvising
    public const string AcadimicAdvising = "Admin";
    public static readonly Guid AcadimicAdvisingId = Guid.Parse("019c1e76-6f5a-7522-8327-a2a72adbbbe8");
    public const string AcadimicAdvisingEmail = "Admin@Universe.com";
    public const string AcadimicAdvisingPassword = "AQAAAAIAAYagAAAAEFhcy5yaaQ5/9U5cfv8MnI3DBzUZ0ido47Hf7N0qKI20sJp8yGuUPuwPOIGdkNQJjA==";
    public const string AcadimicAdvisingSecurityStamp = "96A84AD3C17B4EBD95CE5AC8266BD761";
    public const string AcadimicAdvisingConcurrencyStamp = "019c1e76-a7da-76a1-a6c8-96163fb4a2fc";
}