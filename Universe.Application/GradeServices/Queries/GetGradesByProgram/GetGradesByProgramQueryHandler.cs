...
public class GetGradesByProgramQueryHandler(IUnitOfWork unitOfWork) : IRequestHandler<GetGradesByProgramQuery, Result<PaginationList<GradeResponse>>>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    public async Task<Result<PaginationList<GradeResponse>>> Handle(GetGradesByProgramQuery request, CancellationToken cancellationToken = default)
    {
